...
if (!empty($_POST['cek_input_orderitem'])) {
    ...
    if (mysqli_num_rows($select) > 0) {
        ...
        $query = mysqli_query($conn, "INSERT INTO tb_list_order (menu,kode_order,jumlah,catatan_item) Values ('$menu','$kode_order','$jumlah','$catatan')");
        if ($query) {
