...
if (!empty($_POST['cek_input_order'])) {
    ...
    if (mysqli_num_rows($select) > 0) {
        ...
        $query = mysqli_query($conn, "INSERT INTO tb_order (id_order,meja,pelanggan,pelayan,catatan) Values ('$kode_order','$meja','$pelanggan','$_SESSION[id_user]','$catatan')");
        if ($query) {
